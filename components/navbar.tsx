  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        {/* Replace profile image + text with Logo */}
        <a
          href="#home"
          onClick={(e) => {
            e.preventDefault()
        ...
        >
          <div className="w-10 h-10 rounded-full overflow-hidden">
            <Image src="/images/ik.jpeg" alt="Igmhar Sánchez" width={40} height={40} className="object-cover" />
          </div>
