...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const serviceId = "service_na53dhc"
      const templateId = "template_xfzodny"
      const publicKey = "zOusFUfcnb1PI-L9B"
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">Zacatecas, México</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:sanchezigmhar@hotmail.com" className="text-primary hover:underline">
                    sanchezigmhar@hotmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">+52 1 (492) 173-2215</p>
                </div>
              </div>
            </div>
          </div>
